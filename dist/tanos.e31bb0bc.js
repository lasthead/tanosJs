...
(0, _html2canvas.default)(document.querySelector("#capture")).then(function (canvas) {
  ...
  for (var f = 0; f < width; f++) {
    for (var k = 0; k < height; k++) {
      for (var l = 0; l < 2; l++) {
        var px = 4 * (k * width + f);
        var m = Math.floor(layersCount * (Math.random() + 2 * f / width) / 3);
  ...
  imageslist.forEach(function (imageData, i) {
...
},{"html2canvas":"../../../node_modules/html2canvas/dist/html2canvas.js","./style.less":"style.less"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/tanos.e31bb0bc.js.map